...
public class MapFragment extends Fragment implements OnMapReadyCallback,
    ...
    public void onViewCreated(View rootView, @Nullable Bundle savedInstanceState) {
        ...
        mRadiusCenterLng = Double.parseDouble(centerRad[1]);
...
//        LatLng latLng = new LatLng(37.7750, 122.4183);
        ...
        markerOptions.title(mUserFullName);
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.my_profile_dummy_new));
        mCurrLocationMarker = mMap.addMarker(markerOptions);

        // drawing circle around radius center
